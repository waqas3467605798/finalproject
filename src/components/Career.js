    ...
    return (
      ...
      <form>
         <table>
          ...
          <tr>  <td>Domicile</td>  <td> <input type='text' placeholder='Domicile'/> </td>  </tr>
          ...
          <tr>  <td>Experience</td>  <td> <input type='text' placeholder='Experience in Years'/> </td>  </tr>
          <tr>  <td></td>  <td>  <button onClick={this.formHandler}>Submit</button></td>  </tr>
         </table>
